...
const ASSETS = ['./', './index.html', './config.js', './manifest.webmanifest', './assets/app.css', './assets/app.mjs', './assets/model.mjs', './assets/storage.mjs', './assets/icon.svg', './assets/icon-180.png'];
