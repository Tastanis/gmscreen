...
for (const file of ['player-roster.test.php', 'floor-geometry.test.php', 'floor-movement.test.php', 'airborne-movement.test.php', 'floor-view-lifecycle.test.php', 'scene-checkpoints.test.php']) {
