...
function renderVttTokenLibrary(bool $isGm = false): string
{
    ob_start();
    ?>
            ...
            <?php if ($isGm): ?>
                <section class="token-maker" data-module="vtt-token-maker" aria-label="Token image builder">
                    ...
                    <div class="token-maker__controls">
                        ...
                        <div class="token-maker__field">
                            <label class="token-maker__checkbox" for="token-team-toggle">
                                <input
                                    id="token-team-toggle"
                                    type="checkbox"
                                    name="token-team"
                                    data-token-team-toggle
                                />
                                Make Ally
                            </label>
