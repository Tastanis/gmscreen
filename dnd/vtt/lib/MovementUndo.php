...
final class MovementUndo
{
    ...
    public static function record(array $current, array $next, string $actorId, array $mapLevels, ?string $operationId = null, bool $groupMove = false): array
    {
