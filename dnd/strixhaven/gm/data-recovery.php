...
<head>
    ...
    <title>Data Recovery - GM Screen</title>
...
<body>
    <div class="recovery-container">
        <div class="recovery-header">
            <h1>Data Recovery & Backup Management</h1>
            <div class="recovery-nav">
                <a href="index.php">← Back to GM Screen</a>
        ...
        <div class="recovery-section">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <h3>Auto Backups</h3>
                    <div class="value"><?php echo $stats['by_type']['auto'] ?? 0; ?></div>
                </div>
                <div class="stat-card">
        ...
        <div class="recovery-section">
            ...
            <?php if (empty($backups)): ?>
                <div class="empty-state">
                    ...
                    <p>No backups found. Backups are created automatically when you save your notes.</p>
                </div>
            <?php else: ?>
        ...
        <div class="recovery-section">
            ...
            <div class="alert alert-info">
                ...
                <ul>
                    ...
                    <li>The system keeps the last 5 backups for each file</li>
                    <li>Older backups are automatically removed to save space</li>
            ...
            <div class="alert alert-warning">
                ...
                <ul>
                    ...
                    <li>Make sure you're not opening the GM screen in multiple tabs</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        async function createManualBackup() {
            try {
                ...
                const response = await fetch('data-recovery.php', {
                    method: 'POST',
                    body: formData
                });
            ...
            try {
                ...
                if (result.success) {
                    if (result.valid_json) {
                        showStatus(`Backup is valid! Contains ${result.records} records. Size: ${(result.size / 1024).toFixed(2)} KB`, 'success');
                    } else {
        ...
        async function restoreBackup(backupPath) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    // Redirect to GM screen after 2 seconds
                    setTimeout(() => {
