...
try {
    ...
    [$wordPool, $activeLists] = asl1_bingo_merge_word_sources($pdo, $teacherId, $lists);
    ...
    $session = asl1_bingo_create_session($pdo, $teacherId, BINGO_LEVEL, $activeLists, $wordPool);
    $sessionPayload = asl1_bingo_format_session_payload($session, [], []);
